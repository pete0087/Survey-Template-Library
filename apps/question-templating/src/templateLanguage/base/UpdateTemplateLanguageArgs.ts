...
@ArgsType()
class UpdateTemplateLanguageArgs {
  @Field(() => TemplateLanguageWhereUniqueInput, { nullable: false })
  where!: TemplateLanguageWhereUniqueInput;
  @Field(() => TemplateLanguageUpdateInput, { nullable: false })
  data!: TemplateLanguageUpdateInput;
}

export { UpdateTemplateLanguageArgs as UpdateTemplateLanguageArgs };
