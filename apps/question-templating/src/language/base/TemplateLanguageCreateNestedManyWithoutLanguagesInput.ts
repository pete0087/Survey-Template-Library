...
@InputType()
class TemplateLanguageCreateNestedManyWithoutLanguagesInput {
...
export { TemplateLanguageCreateNestedManyWithoutLanguagesInput as TemplateLanguageCreateNestedManyWithoutLanguagesInput };
