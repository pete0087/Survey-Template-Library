...
@InputType()
class TemplateLanguageCreateNestedManyWithoutTemplatesInput {
...
export { TemplateLanguageCreateNestedManyWithoutTemplatesInput as TemplateLanguageCreateNestedManyWithoutTemplatesInput };
