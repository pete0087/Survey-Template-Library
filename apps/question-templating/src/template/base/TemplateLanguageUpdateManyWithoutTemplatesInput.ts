...
@InputType()
class TemplateLanguageUpdateManyWithoutTemplatesInput {
...
export { TemplateLanguageUpdateManyWithoutTemplatesInput as TemplateLanguageUpdateManyWithoutTemplatesInput };
